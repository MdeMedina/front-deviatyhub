...
import { Search, MessageSquare, Calendar, Clock, Share2 } from 'lucide-react'
      ...
      <div className="flex-1 overflow-y-auto">
        {isLoading ? (
          ...
          <div className="p-6 text-center">
            <p className="text-[13px] text-[var(--neg)] mb-3">Error al cargar conversaciones</p>
            <button 
              onClick={() => refetch()}
    ...
    >
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        <div className="w-5 h-5 rounded-[4px] border border-[var(--line)] bg-[var(--surface)] flex items-center justify-center text-[var(--muted)]">
          {isWhatsApp ? <MessageSquare size={10} /> : <Share2 size={10} />}
        </div>
        <Badge 
          variant={
